...
def test_sorter_movement(tmp_path):
...
def test_sorter_missing_file(tmp_path):
    file_path = tmp_path / "test_sorter.txt"
    res_dir = tmp_path / "res"
    res_dir = Sorter(res_dir)
    result = res_dir.sort(file_path, "spam")
...
def test_sorter_duplicate_file(tmp_path):
    file_path = tmp_path / "test_sorter.txt"
...
def test_sorter_categories(category, tmp_path):
    file_path = tmp_path / "test_sorter.txt"
